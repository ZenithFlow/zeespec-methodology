---
doc: core/templates/_meta/metrics-loop
type: meta-template
version: 2.3.0
status: stable
...
| Version | Modules | Avg authoring time / module | Reviewer wall-time / module | Findings / module (avg) | P0 | P1 | P2 | Drift-catch rate | False-positive rate | P0/P1 INV w/o test ptr | Modules @ Lite | @ Standard | @ Full |
|---------|--------:|----------------------------:|----------------------------:|------------------------:|---:|---:|---:|-----------------:|--------------------:|-----------------------:|---------------:|-----------:|-------:|
| vX.Y.Z  | N       | Nh                          | Nh                          | N                       | N  | N  | N  | N% (caught / total real drift) | N% (false flags / total flags) | N | N | N | N |
...
- **P0/P1 INV w/o test ptr** = invariants whose violation severity is P0/P1 but which carry no test pointer / executable assertion (B1 § 6 count, summed across modules; target 0).
...
| Version | Modules | Avg authoring time / module | Reviewer wall-time / module | Findings / module (avg) | P0 | P1 | P2 | Drift-catch rate | False-positive rate | P0/P1 INV w/o test ptr | Modules @ Lite | @ Standard | @ Full |
|---------|--------:|----------------------------:|----------------------------:|------------------------:|---:|---:|---:|-----------------:|--------------------:|-----------------------:|---------------:|-----------:|-------:|
| v3.0.0  | 5       | ~5.2h                       | not tracked at N=1          | 35 (177 total)          | not split at N=1 | — | — | not tracked at N=1 | not tracked at N=1 | not tracked at N=1 | 0 | 0 | 5 |
