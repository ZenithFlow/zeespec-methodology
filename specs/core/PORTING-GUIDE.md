...
Read `docs/specs/zeespec/core/workflow/00-START-HERE.md` BEFORE generating code that touches
...
Follow `core/workflow/01-authoring-checklist.md`. Read existing docs + production code first.

### 5. Run B1 + R3 + R1+R2 reviews (3-4 hours)

Follow `core/workflow/02-b1-verification.md` through `core/workflow/04-r1-r2-parallel-review.md`.
...
Customize `core/checklists/severity-matrix.md` for your domain.

## Adapting compliance reviewers (R2)

The R2 reviewer prompt in `core/workflow/04-r1-r2-parallel-review.md` contains a `[your jurisdiction + applicable regulations]` placeholder followed by examples. Replace with **your** jurisdiction. Reference table for common ones:
...
When customizing R1/R2 reviewer prompts in `core/workflow/04-r1-r2-parallel-review.md` for your stack, substitute these conventions:
...
## Next: read `core/workflow/00-START-HERE.md`
