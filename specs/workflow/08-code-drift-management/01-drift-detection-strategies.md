---
doc: workflow/08-code-drift-management/01-drift-detection-strategies
...
discretion required. See `workflow/08-code-drift-management/02-drift-categorization.md`
...
- `workflow/02-b1-verification.md` — initial baseline (foundational for Layer 1/2)
- `workflow/06-spawn-task-chips.md` — when Type 3/4 drift = production bug
