---
doc: workflow/10-adoption-guide/04-tooling-integration
...
Drop into `.github/workflows/zeespec-drift.yml` (full template per `workflow/08-code-drift-management/03-auto-drift-detection.md`).
...
Pattern same — per `workflow/08-code-drift-management/03-auto-drift-detection.md` § "GitLab CI workflow".
...
1. Read `docs/specs/zeespec/workflow/00-START-HERE.md`
      ...
      - name: Dispatch R5 quick-scan agent
        run: |
          ...
          claude-agent dispatch \
            --prompt-file docs/specs/zeespec/workflow/08-code-drift-management/05-R5-drift-scanner-agent.md \
            --mode quick-scan \
...
- `workflow/08-code-drift-management/03-auto-drift-detection.md` — CI script reference
- `workflow/07-r4-regulatory-research/09-amendment-tracking.md` — source monitoring patterns
