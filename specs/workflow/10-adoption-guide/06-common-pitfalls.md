---
doc: workflow/10-adoption-guide/06-common-pitfalls
...
- Set up CI drift detection (Layer 1) per `workflow/08-code-drift-management/03`
...
- For systemic drift: bulk cleanup sprint (per `workflow/08-code-drift-management/04` § "Bulk drift cleanup")
...
- R6 annual review per `workflow/09-adr-lifecycle/05-R6-adr-curator-agent.md` Mode B
...
**Prevention:** Per `workflow/08-code-drift-management/03-auto-drift-detection.md` § "Tuning signal-to-noise" — explicit tuning step in rollout.
