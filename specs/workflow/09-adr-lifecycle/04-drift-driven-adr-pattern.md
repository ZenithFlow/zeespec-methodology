---
doc: workflow/09-adr-lifecycle/04-drift-driven-adr-pattern
...
> Type 3-design + Type 4 drift findings (per `workflow/08-code-drift-management/02-drift-categorization.md`) trigger retroactive ADR creation; the ADR documents WHY the change happened; spec updates align with the new design.
...
- `workflow/08-code-drift-management/02-drift-categorization.md` — Type 3-design + Type 4 trigger this pattern
- `workflow/08-code-drift-management/04-drift-resolution-playbook.md` — Recipe T3-design + T4
