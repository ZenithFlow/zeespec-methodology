---
doc: workflow/09-adr-lifecycle/01-adr-format-template
...
1. **ID** — `ADR-<MOD>-NNN` per `checklists/invariant-numbering.md`
...
Per `checklists/invariant-numbering.md`:
...
- `checklists/invariant-numbering.md` — ID format
