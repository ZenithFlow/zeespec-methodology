---
doc: workflow/09-adr-lifecycle/00-START-HERE
type: workflow-entry
phase: adr-lifecycle
version: 1.0.0
status: stable
...
- `workflow/08-code-drift-management/04-drift-resolution-playbook.md` — Recipe T3-design + T4 produce ADRs
- `workflow/01-authoring-checklist.md` Phase 12 — CLAUDE.md ADR table
- `checklists/invariant-numbering.md` — ADR numbering conventions (`ADR-<MOD>-NNN`)
- `templates/_template/CLAUDE.md` — ADR table template
