---
doc: workflow/09-adr-lifecycle/05-R6-adr-curator-agent
type: agent-prompt
phase: adr-lifecycle
version: 1.0.0
status: stable
...
- `docs/specs/zeespec/workflow/09-adr-lifecycle/00-START-HERE.md`
...
- `workflow/08-code-drift-management/05-R5-drift-scanner-agent.md` — R5 feeds into R6
