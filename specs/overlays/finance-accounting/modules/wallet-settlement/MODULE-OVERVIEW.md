...
> Condensed reference for the wallet/payment/settlement module. When you author this module in your project, expand each numbered section below into the corresponding ZeeSpec file (CLAUDE.md, why.md, what.md, etc.) per core ZeeSpec workflow/01-authoring-checklist.md.
