---
doc: overlays/finance-accounting/principles/severity-matrix-finance
type: principles-spec
overlay: finance-accounting
overrides: checklists/severity-matrix.md
version: 0.1.0
status: experimental
...
> **Overrides** core `checklists/severity-matrix.md` with financial-services-specific calibration. Use this matrix when triaging gaps in any module under the finance-accounting overlay.
