---
doc: overlays/frontend-design-system/testing/ui-testing
type: testing-spec
...
|------------------------|-------------------------------|
| BDD / executable assertion — § 3c + `workflow/07-r4-regulatory-research/03-citation-conventions.md` *From citation to executable assertion* | A spec rule (a component-contract state, a CRUD Given/When/Then) becomes a **Storybook play function** or a **Playwright test**. The rule is the source; the test is the enforcement. |
...
- Core ZeeSpec `workflow/07-r4-regulatory-research/03-citation-conventions.md` — *From citation to executable assertion*
- Core ZeeSpec `scripts/ci-drift-gate.sh` + `workflow/08-code-drift-management/` — the drift-gate pattern Chromatic/axe mirror
