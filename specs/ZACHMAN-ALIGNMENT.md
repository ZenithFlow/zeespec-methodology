...
> **Төлөв:** PARTIALLY-IMPLEMENTED — §8 шийдвэрүүд тогтсон (2026-05-29); **Tier 1·1A + §4 drift-fixes
> хэрэгжсэн** (Path A — §11 implementation log үз). Үлдсэн tier (1B / 1C / 2 / 3) зориуд хойшлуулсан.
> Хэрэгжүүлэх дараалал §7-д.
