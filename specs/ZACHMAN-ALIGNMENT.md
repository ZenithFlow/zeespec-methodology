...
- **Хөндөгдөх файл:** `templates/_template/gravity.md`; `overlays/finance-accounting/modules/general-ledger/gravity.md` (worked example); `METHODOLOGY.md` §9 (Gravity).
- **Effort:** M.
...
- **Хөндөгдөх файл:** `workflow/08-code-drift-management/05-R5-drift-scanner-agent.md`; `workflow/08-code-drift-management/02-drift-categorization.md` (шинэ normalization category); `workflow/03-r3-deep-review.md`.
- **Effort:** M.
...
- **Хөндөгдөх файл:** шинэ `_meta/zeespec-self-spec/`; repo root-д шинэ CI config; `templates/_meta/pilot-retrospective.md` (metrics холбоно).
...
- **Хөндөгдөх файл:** `METHODOLOGY.md` §1–2 & §4 (status tags) & §7 (two-layer); `workflow/00-START-HERE.md`.
- **Effort:** S–M.
...
- **Хөндөгдөх файл:** `workflow/01-authoring-checklist.md`; `workflow/10-adoption-guide/00-START-HERE.md`; `workflow/10-adoption-guide/07-zeespec-lite-tier-0-fasttrack.md`.
- **Effort:** S.
...
- **Хөндөгдөх файл:** `workflow/09-adr-lifecycle/00-START-HERE.md`; `METHODOLOGY.md` §1.
- **Effort:** S.
...
- [x] **Filename / location** — `specs/ZACHMAN-ALIGNMENT.md` хэвээр (`METHODOLOGY.md`-ийн peer; `_meta/` нь adopting төсөлд хуулдаг template-уудад зориулагдсан).
...
**Хийгдсэн:**
- **1A** — `gravity.md` → pointer-only ("one fact, one cell"): `templates/_template/gravity.md`, `overlays/finance-accounting/modules/general-ledger/gravity.md` (20 HW → pointer; `HW-GL-14`/`HW-GL-16` → alias), `METHODOLOGY.md §9` (convention документжсэн). Баталгаажсан: GL gravity-д restated substance үлдсэнгүй.
...
- **2B** — `01-authoring-checklist.md`-д authoring dependency DAG (WHY→WHAT→HOW→{WHO,WHEN}→WHERE) + Tier 0 Lite-г default; `10-adoption-guide/00-START-HERE.md`-д Lite-default. Мөн Phase 9 gravity-г pointer-only болгож 1A-completion (хуучин формат хоцорсныг зассан).
