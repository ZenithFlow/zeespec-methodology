---
doc: examples/overlays/finance-accounting/prompts/R2-financial-reviewer
type: agent-prompt
overlay: finance-accounting
overrides: core/workflow/04-r1-r2-parallel-review.md (R2 section)
version: 0.1.0
status: experimental
...
> **Replaces** the generic R2 prompt in core ZeeSpec `core/workflow/04-r1-r2-parallel-review.md` when reviewing a module that uses the finance-accounting overlay. Tuned to financial-services + FRC compliance.
...
ZeeSpec core/workflow/06-spawn-task-chips.md]
...
- Core ZeeSpec `core/workflow/04-r1-r2-parallel-review.md` — generic R1+R2 framework
- Core ZeeSpec `core/workflow/06-spawn-task-chips.md` — chip dispatch
