---
doc: examples/overlays/finance-accounting/principles/financial-invariants-catalog
...
- Status tag conventions per core ZeeSpec `core/checklists/status-tags.md`
