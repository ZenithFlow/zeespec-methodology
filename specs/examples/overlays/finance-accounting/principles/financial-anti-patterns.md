---
doc: examples/overlays/finance-accounting/principles/financial-anti-patterns
...
> Extends the core ZeeSpec anti-patterns (`core/checklists/anti-patterns.md`). Catalogued from the pilot project. Many of these are caused by NOT having a strong accounting model up front.
...
The core ZeeSpec anti-patterns in `core/checklists/anti-patterns.md` ALL still apply to finance modules. The 15 here are additive.
