---
doc: examples/overlays/finance-accounting/principles/regulatory-compliance
...
>
> For **how to research your jurisdiction's specifics** (regulator website navigation, law citation conventions, periodic re-check workflow), see core ZeeSpec `extended/workflow/07-r4-regulatory-research/` (promoted to core in v2.7). Finance-specific worked examples in `../research-examples/`.
...
For step-by-step research methodology to discover YOUR jurisdiction's specifics, see `/specs/extended/workflow/07-r4-regulatory-research/00-START-HERE.md`.

## 8. References

(See `/specs/extended/workflow/07-r4-regulatory-research/05-source-cheatsheet.md` for full source URL list per regulator + domain.)
...
→ `/specs/extended/workflow/07-r4-regulatory-research/00-START-HERE.md` — research methodology (in core ZeeSpec)
