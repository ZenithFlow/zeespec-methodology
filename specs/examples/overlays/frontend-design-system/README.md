---
doc: examples/overlays/frontend-design-system/README
...
1. **Core ZeeSpec first** — `/specs/README.md` + `/specs/core/METHODOLOGY.md` (esp. § 3c executable assertions) + `/specs/core/workflow/00-START-HERE.md`.
...
cp -r path/to/zeespec-methodology/specs/examples/overlays/frontend-design-system \
...
| Executable assertions / BDD (`METHODOLOGY.md` § 3c; `extended/workflow/07-r4-regulatory-research/03-citation-conventions.md`) | **Storybook play functions** + **axe assertions** ARE the runnable form of a UI rule |
...
| ADRs (`extended/workflow/09-adr-lifecycle/`) | Design-system decisions (token scale, theming strategy, component-library choice) |
...
```
examples/overlays/frontend-design-system/
├── README.md                                — this file
├── stack/
