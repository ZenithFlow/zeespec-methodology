---
doc: extended/workflow/08-code-drift-management/04-drift-resolution-playbook
...
3. File spawn task chip per core/workflow/06-spawn-task-chips.md:
...
2. Write retroactive ADR per extended/workflow/09-adr-lifecycle/04-drift-driven-adr-pattern.md
...
4. Bidirectional cross-link updated per `core/checklists/cross-link-bidirectionality.md`
...
- `core/workflow/06-spawn-task-chips.md` — chip format (Recipe T3-bug)
- `extended/workflow/09-adr-lifecycle/04-drift-driven-adr-pattern.md` — Recipe T3-design + T4
- `core/checklists/severity-matrix.md` — severity calibration
- `core/checklists/cross-link-bidirectionality.md` — multi-module drift

## Next

→ `05-R5-drift-scanner-agent.md` — AI agent for drift scanning
→ `extended/workflow/09-adr-lifecycle/` — ADR workflow that complements drift resolution
