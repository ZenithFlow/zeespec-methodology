---
doc: extended/workflow/07-r4-regulatory-research/01-regulatory-research-workflow
...
→ `examples/overlays/finance-accounting/research-examples/01-frc-investment-fund-regulation.md` — full worked example
