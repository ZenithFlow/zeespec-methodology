---
doc: extended/workflow/07-r4-regulatory-research/09-amendment-tracking
...
R4 recommends ADR action:
  - If amendment merely tightens a parameter → "amendment-driven ADR update":
    ...
    - Dispatch R6 Mode A (per `extended/workflow/09-adr-lifecycle/05-R6-adr-curator-agent.md`) to draft new ADR-KYC-NNN+1
...
This is the **authority-driven retroactive ADR pattern** — symmetric to the code-drift-driven retroactive ADR pattern in `extended/workflow/09-adr-lifecycle/04-drift-driven-adr-pattern.md`.
