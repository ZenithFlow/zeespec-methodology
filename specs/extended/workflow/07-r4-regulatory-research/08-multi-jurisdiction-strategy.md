---
doc: extended/workflow/07-r4-regulatory-research/08-multi-jurisdiction-strategy
...
- `examples/overlays/finance-accounting/research-examples/03-retention-research-cross-jurisdiction.md` — worked example
