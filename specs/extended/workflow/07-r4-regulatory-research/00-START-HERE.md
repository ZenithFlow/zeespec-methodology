---
doc: extended/workflow/07-r4-regulatory-research/00-START-HERE
...
- `examples/overlays/finance-accounting/research-examples/` — 4 finance research sessions:
...
- (future) `examples/overlays/healthcare/research-examples/`
- (future) `examples/overlays/government/research-examples/`
- (future) `examples/overlays/privacy/research-examples/`
...
|--------|-----------------|
| **Financial services** | `examples/overlays/finance-accounting/research-examples/01-frc-investment-fund-regulation.md`, `02-mongolia-aml-law-research.md`, `03-retention-research-cross-jurisdiction.md`, `04-mongolia-lending-research.md` |
| Healthcare | (future) `examples/overlays/healthcare/research-examples/01-hipaa-phi-research.md`, etc. |
| Government / FedRAMP | (future) `examples/overlays/government/research-examples/01-fedramp-controls.md`, etc. |
| Privacy / GDPR | (future) `examples/overlays/privacy/research-examples/01-gdpr-art-17-erasure.md`, etc. |
