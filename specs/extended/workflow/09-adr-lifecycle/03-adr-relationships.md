---
doc: extended/workflow/09-adr-lifecycle/03-adr-relationships
...
Per `core/checklists/cross-link-bidirectionality.md`:
...
- `core/checklists/cross-link-bidirectionality.md` — cross-module rules
