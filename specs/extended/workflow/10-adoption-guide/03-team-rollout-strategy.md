---
doc: extended/workflow/10-adoption-guide/03-team-rollout-strategy
...
- core/workflow/00-START-HERE.md + core/workflow/01-authoring-checklist.md (30 min)
...
- `extended/workflow/08-code-drift-management/` — continuous discipline
- `extended/workflow/09-adr-lifecycle/` — decision capture
