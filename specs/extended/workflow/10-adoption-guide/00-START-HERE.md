---
doc: extended/workflow/10-adoption-guide/00-START-HERE
type: workflow-entry
phase: adoption
version: 1.0.0
status: stable
...
>
> Different from `PORTING-GUIDE.md` (which is about adapting to your stack) and from `core/workflow/01-authoring-checklist.md` (which is per-module authoring). This is **organizational adoption strategy**.
...
| AI agent doing per-module work | ❌ Use `core/workflow/00-START-HERE.md` instead |
...
- `core/workflow/00-START-HERE.md` — per-module workflow entry (after adoption)
- `core/workflow/01-authoring-checklist.md` — first-module authoring
