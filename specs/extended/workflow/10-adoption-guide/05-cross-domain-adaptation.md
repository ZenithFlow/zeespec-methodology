---
doc: extended/workflow/10-adoption-guide/05-cross-domain-adaptation
...
For each:
- Identify primary regulator(s) — per `extended/workflow/07-r4-regulatory-research/05-source-cheatsheet.md`
...
```bash
mkdir -p examples/overlays/<domain>/{principles,modules,prompts,glossary,research-examples}

# E.g., healthcare:
mkdir -p examples/overlays/healthcare/{principles,modules,prompts,glossary,research-examples}
```
...
For each principles file you're authoring, dispatch R4 agent per `extended/workflow/07-r4-regulatory-research/04-R4-agent-prompt.md`. Parameterize:
...
**Overlay folder name:** `examples/overlays/healthcare/`
...
**Overlay folder name:** `examples/overlays/government-fedramp/`
...
**Primary differences:**
- Many jurisdictions; MAX rule per `extended/workflow/07-r4-regulatory-research/08-multi-jurisdiction-strategy.md` is critical
...
**Overlay folder name:** `examples/overlays/privacy/`
...
**Overlay folder name:** `examples/overlays/ecommerce-pci/`
...
**Overlay folder name:** `examples/overlays/energy-nerc/`
...
**Overlay folder name:** `examples/overlays/education-ferpa/`
...
- Contribute back as `examples/overlays/<domain>/` to the methodology repo
...
**Symptom:** `examples/overlays/finance-and-healthcare/`

**Fix:** Each domain its own overlay. Different regulators; different invariants; different severity calibration.

## Cross-references

- `examples/overlays/finance-accounting/README.md` — structural model
- `extended/workflow/07-r4-regulatory-research/05-source-cheatsheet.md` — multi-domain authority URLs
- `extended/workflow/07-r4-regulatory-research/00-START-HERE.md` — research methodology
