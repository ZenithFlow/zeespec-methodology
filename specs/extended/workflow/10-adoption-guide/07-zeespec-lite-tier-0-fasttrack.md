---
doc: extended/workflow/10-adoption-guide/07-zeespec-lite-tier-0-fasttrack
...
Per `core/workflow/01-authoring-checklist.md`:
...
Per `core/workflow/02-b1-verification.md` through `04-r1-r2-parallel-review.md`. Time: 1 week.
...
- `core/workflow/01-authoring-checklist.md` — full Tier 1 authoring

## Next

→ Back to `00-START-HERE.md` for navigation
→ Or: `core/workflow/00-START-HERE.md` for per-module workflow
