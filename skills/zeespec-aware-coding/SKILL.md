...
4. **Cite the rule in a code comment.** Every change cites the ID it enforces — `// INV-<MOD>-NN`, `// HW-<MOD>-NN`, `// FU-<MOD>-NAME` — in your language's comment syntax. The citation is the bridge back to the spec when code drifts. → `00-START-HERE.md` § Citing IDs.
