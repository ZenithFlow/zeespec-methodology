...
3. **Apply findings** per `05-apply-findings.md` — fold spec drift back; spawn task chips for real production bugs (`06-spawn-task-chips.md`). **Never auto-fix without review.**
